                ...
                <div className="bg-gray-800 text-white  py-20">
                    <div className="container mx-auto flex flex-col md:flex-row my-6 md:my-24">
                        <div className="flex flex-col w-full lg:w-1/3 p-8">
                            <p className="ml-6 text-green-600 text-lg uppercase tracking-loose">REVIEW</p>
                                            ...
                                            <div className="flex-auto p-5 lg:p-10">
                                                ...
                                                <form id="feedbackForm" action="" method="">
                                                    <div className="relative w-full mb-3">
                                                        ...
                                                        <input type="email" name="email" id="email" className="border-0 px-3 py-3 rounded text-sm shadow w-full bg-gray-300 placeholder-black text-gray-800 outline-none focus:bg-gray-400" placeholder=" " style={{ transition: 'all 0.15s ease 0s' }} required />
                                                    </div>
                                                    <div className="relative w-full mb-3">
                                                    ...
                                                    <div className="text-center mt-6">
                                                        <button id="feedbackBtn" className="bg-green-600 text-white text-center mx-auto active:bg-yellow-400 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1" type="submit" style={{ transition: 'all 0.15s ease 0s' }}>Submit</button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
