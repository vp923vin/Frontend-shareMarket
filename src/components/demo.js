    ...
    <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
      ...
      <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
        ...
        <div className="flex-1 flex flex-col justify-center ">
          ...
          >
            4 years back, I started freelancing as a developer. Since then, I've
        ...
        >
          ...
          <div className="py-2 xl:py-6 flex flex-col gap-y-2 xl:gap-y-4 items-center xl:items-start">
            {/* {aboutData[index].info.map((item, iconIndex) => (
              <div
                key={iconIndex}
            ...
            {aboutData[index].info.map((item, itemIndex) => (
              ...
              >
                ...
                <div key={`separator-${itemIndex}`} className="hidden md:flex">
                  -
                </div>
...
//       <div className="container mx-auto h-full flex flex-col items-center xl:flex-row gap-x-6">
//         <div>
//           <h2 className="text-4xl font-bold mb-4"> {aboutData[index].title}</h2>
//           {aboutData[index].info.map((item, itemIndex) => (
//             <div key={itemIndex}>
