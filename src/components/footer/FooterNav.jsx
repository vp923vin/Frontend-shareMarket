            ...
            <section className='pt-12'>
                <nav className="dark:bg-gray-700">
                    <div className="container py-3 mx-auto">
                        ...
                        <p className='text-white py-2'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Earum veritatis eveniet vitae consectetur ex. Nulla debitis velit beatae praesentium delectus doloribus ipsa, voluptatibus nostrum eveniet quibusdam tempore consequuntur totam in!</p>
