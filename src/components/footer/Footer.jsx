...
const Footer = () => {
    return (
        <>
            ...
            <footer class="bg-blue-700 text-white body-font">
                <div class="container px-5 py-16 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
                    <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                        <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                            ...
                            <span class="ml-3 text-xl text-white">Logo</span>
                        </a>
                    ...
                    <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left">
                        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                            <h2 class="title-font font-medium text-white tracking-widest uppercase text-sm mb-3"> Links</h2>
                        ...
                        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                            <h2 class="title-font font-medium text-whitetracking-widest text-sm  uppercase mb-3">Our Services</h2>
                            <nav class="list-none mb-10">
                                <li className='py-2'>
                                    <a class="text-white ">First Link</a>
                                </li>
                        ...
                        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                            <h2 class="title-font font-medium text-whitetracking-widest text-sm uppercase mb-3">CATEGORIES</h2>
                            <nav class="list-none mb-10">
                                <li className='py-2'>
                                    <a class="text-white ">First Link</a>
                                </li>
                        ...
                        <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                            <h2 class="title-font font-medium text-whitetracking-widest uppercase text-sm mb-3">Contact</h2>
                            <nav class="list-none mb-10">
                                <li className='py-2'>
                                    <a class="text-white ">First Link</a>
                                </li>
                ...
                <div className="flex sm:justify-end items-center pb-2">
